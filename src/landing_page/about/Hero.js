...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted " style={{lineHeight:"1.8", fontSize:"18px" }}>
        <div className="col-6 p-5">
          <p>
            ...
            barrier.
            <p>
              <br />Today, our disruptive pricing models and in-house technology have
