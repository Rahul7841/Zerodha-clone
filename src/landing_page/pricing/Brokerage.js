    ...
    <div className="container">
      <div className="row p-4 mt-5 border-top">
        <div className="col-8 p-4 text-left">
          <h3 className="fs-5">Brokarage calculator</h3>
          <ul className="text-muted">
            <li>Charged by exchanges (NSE, BSE, MCX) on the value of your
            transactions.</li>
            <li>BSE has revised transaction charges in XC, XD, XT, Z
            and ZP groups to ₹10,000 per crore w.e.f 01.01.2016. (XC and XD
            groups have been merged into a new group X w.e.f 01.12.2017)</li>
            <li>BSE has
            revised transaction charges in SS and ST groups to ₹1,00,000 per
            crore of gross turnover.</li>
            <li>BSE has revised transaction charges for
            ...
            rate basis w.e.f. December 1, 2022.</li> 
            <li>BSE has revised transaction
